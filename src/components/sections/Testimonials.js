      ...
      <div className="testimonials-container flex-column-mobile">
          ...
          <div>
            <p>
              <span className="quote">
                " I worked with Shanto, he was very helpful and fast to respond
                to my inquiry to help with Adobe Photoshop website issues and all
                technical problems. "
              </span>
        ...
        <div className="quote-container animated-layer fade-in-right-animation fadeInUp wow">
          <div>
            <p>
              <span className="quote">
                " Shanto is a great help managing a very out of date website.
